...
# 🏢 스마트 아파트 통합관리 플랫폼 By Team 파이브가이즈

IoT와 AI 기술을 활용하여 아파트의 다양한 서비스를 하나의 플랫폼으로 통합한 스마트 아파트 관리 시스템입니다.
입주민 앱과 관리자 웹을 통해 공지사항, 민원 관리, 관리비 조회, IoT 기기 제어, ChatBot, 안전 모니터링 등 다양한 기능을 제공합니다.
